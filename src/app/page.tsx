          ...
          <div className="mx-auto ">
            <div className="group box-content">
              ...
              <ContentBlock className="mt-[400px]">
                ...
                <div className="text-lg md:text-xl lg:text-xl text-brand-dark-950 pt-4">
                  ...
                  mobile architecture, and implementing seamless UI/UX
                  experiences on Web and Mobile. With over 15 years of extensive
                  experience in the digital industry spanning product
                  development, user experience design, and advertising.
                  Possessing an unwavering passion for crafting interfaces,
                  products, and applications that deliver exceptional
                  performance, and break technological boundaries.
                  <div className="h-3" />
            ...
            <Element name="experience">
              <ContentBlock className="overflow-hidden group pb-4">
                <h2 className="pt-8 text-2xl md:text-3xl lg:text-5xl text-left text-brand-dark-950">
                  <span className="text-brand-600 group-hover:text-brand-300">
                    _{' '}
                  </span>
                  Work Experience
